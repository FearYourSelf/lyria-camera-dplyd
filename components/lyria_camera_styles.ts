...
export default css`
  ...
  .material-icons-round {
    ...
    /* Fix: Prevent parent text-transform from breaking icon ligatures */
  ...
  .sheet {
    ...
    pointer-events: auto;
    animation: slideSheet 0.5s cubic-bezier(0.19, 1, 0.22, 1);
  }
  ...
  .preset-card p { margin: 0.3rem 0 0; font-size: 0.8rem; opacity: 0.45; }
